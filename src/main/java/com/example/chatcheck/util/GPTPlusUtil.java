...
public class GPTPlusUtil {
    ...
    static String authorization = "Bearer sk-AAcy6QUi3rFopVUm61A0C5BbC4D6438c96Ef7660Cd30Ec2f";
...
//                .header(Header.CONTENT_TYPE, "application/json");
    ...
    public static void sendMsg3(String msg, ResponseHandler handler) {
        // 设置请求URL和参数
        String url = "https://chat.openai.com/backend-api/conversation";
        ...
        // 设置请求头部信息
        BoundRequestBuilder requestBuilder = client.preparePost(url).setProxyServer(proxy)
    ...
    public static void sendMsg4(String msg, HttpServletResponse response) {
        // 设置请求URL和参数
        String url = "http://apic.littlewheat.com/v1/chat/completions";
        ProxyServer proxy = new ProxyServer.Builder("127.0.0.1", 7890).build();
